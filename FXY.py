...
from feature_vec.model import lstm_3D,lstm_2D,textcnn_2D
...
# feature engineering
nlp=wordindex() # init feature class
...
model=textcnn_2D(max_len=nlp.max_length,input_dim=nlp.input_dim,output_dim=8)
